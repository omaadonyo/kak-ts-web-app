    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="-mb-px max-lg:hidden">
                ...
                <flux:navbar.item icon="plus" :href="route('book-service')" :current="request()->routeIs('book-service')" wire:navigate>
                    {{ __('Book a Service') }}
                </flux:navbar.item>

                <flux:navbar.item icon="list-bullet" :href="route('book-services')" :current="request()->routeIs('book-services*')" wire:navigate>
                    {{ __('My Services') }}
                </flux:navbar.item>
            </flux:navbar>
