...
<div class="w-full md:w-1/2 md:mx-auto space-y-6">
    ...
    @if ($invoice && $status === 'sent')
        <flux:button wire:click="markPaid" variant="primary" class="bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-400">Mark as Paid</flux:button>
    @endif
</div>
