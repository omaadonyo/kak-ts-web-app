...
<div class="w-full max-w-7xl mx-auto px-4 py-6 space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 shadow-sm overflow-hidden sticky top-6">
                        ...
                        <div class="p-6">
                            <div class="text-center border-b border-zinc-100 dark:border-zinc-700 pb-4 mb-4">
                            ...
                            @endif
                            @if ($validUntil)
                                <div class="mt-3 text-xs text-zinc-400 dark:text-zinc-500 border-t border-zinc-100 dark:border-zinc-700 pt-3">
                                    Valid until: {{ \Carbon\Carbon::parse($validUntil)->format('M d, Y') }}
                                </div>
                            @endif
                        </div>
                    </div>
    ...
    @else
        <div class="max-w-md mx-auto bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 shadow-sm p-6 text-center">
